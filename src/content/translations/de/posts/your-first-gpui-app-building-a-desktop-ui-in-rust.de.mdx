...
Eine Sache, die ich erklären möchte: `ghost()` stammt aus der Component-Schicht von GPUI Kit für die `Button`-Komponente. Es ist nur eine Stilsache; wir erstellen diesen Stil nicht manuell.
